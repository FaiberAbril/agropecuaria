...
public class Producto {
	...
	private LocalDate fechaRegistroProdcuto;
	...
	public Producto(long idProducto, String nombreProducto, String descripcionProducto, double precioProducto,
			double precioUnitario, CategoriaProducto categoriaProdProducto, int stockProducto,
			UnidadMedida unidadMedidaProducto, LocalDate fechaRegistroProdcuto) {
		super();
	...
	public LocalDate getFechaRegistroProdcuto() {
		return fechaRegistroProdcuto;
	}

	public void setFechaRegistroProdcuto(LocalDate fechaRegistroProdcuto) {
		this.fechaRegistroProdcuto = fechaRegistroProdcuto;
	}
