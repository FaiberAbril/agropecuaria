...
public class ClienteControlador {
	...
	public String formularioActualizarCliente(Model model, @PathVariable("idCliente") Long idCliente) {
		model.addAttribute("ObjClienteActualizado", clienteServicios.BuscarCliente(idCliente));
		return "formularioActualizarCliente";
	}
	
	@PostMapping("/actualizarCliente")
	public String ActualizarCliente(@ModelAttribute("ObjClienteActualizado") Cliente cliente) {
